...
__decorate([
    (0, typeorm_1.ManyToOne)(() => RefundStatus_1.RefundStatus, (status) => status.payments, { nullable: true, onDelete: 'SET NULL' }),
    (0, typeorm_1.JoinColumn)({ name: "refund_status_id" }),
    __metadata("design:type", RefundStatus_1.RefundStatus)
